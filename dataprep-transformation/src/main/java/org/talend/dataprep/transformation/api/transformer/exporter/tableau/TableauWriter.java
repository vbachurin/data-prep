    ...
    public void write(final DataSetRow row) throws IOException {
        ...
        try {
            ...
            for(int i =0; i<columnMetadatas.length;i++){
                ...
                switch(typeCol) {
                    case ANY: tableauRow.setString(i,value);
                        break;
                    case STRING: tableauRow.setString(i,value);
                        break;
                    case NUMERIC:
                    case INTEGER:
                    ...
                    case BOOLEAN:
                        ...
                        break;
                    case DATE: tableauRow.setString(i, value);
                        break;
                    default: row.get(columnMetadatas[i].getId());
                }
            }
