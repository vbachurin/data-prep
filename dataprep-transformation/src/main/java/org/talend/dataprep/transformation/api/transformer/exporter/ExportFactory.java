...
public class ExportFactory {
    ...
    public Transformer getExporter(final ExportConfiguration configuration) {
        ...
        switch(configuration.getFormat()) {
            case CSV : return get(CsvExporter.class, actionConsumer, configuration.getCsvSeparator());
    ...
    public Transformer get(final Class<? extends Transformer> transformerClass, final ParsedActions actionConsumer, final Character csvSeparator) {
        return context.getBean(transformerClass, actionConsumer, csvSeparator);
    }
}
