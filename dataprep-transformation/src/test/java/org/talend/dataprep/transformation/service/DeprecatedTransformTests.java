 ...
 */
public class DeprecatedTransformTests extends TransformationServiceBaseTests {
    ...
    public void splitActionWithFilter() throws Exception {
        ...
        final String initialContent = IOUtils
                .toString(Application.class.getResourceAsStream("actions/input_changeDomainAction.json"));
        final String expectedContent = IOUtils
    ...
    public void splitAction() throws Exception {
        ...
        final String initialContent = IOUtils.toString(Application.class.getResourceAsStream("actions/input_split.json"));
        final String expectedContent = IOUtils
