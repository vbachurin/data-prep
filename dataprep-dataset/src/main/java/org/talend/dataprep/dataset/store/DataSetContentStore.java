...
public interface DataSetContentStore {
     ...
     * 
     * @param dataSetMetadata The data set metadata attached to the {@link org.talend.dataprep.dataset.objects.DataSetMetadata data set}
     * .
    ...
    /**
     * Returns the {@link org.talend.dataprep.dataset.objects.DataSetMetadata data set} content as <b>JSON</b> format. Whether
     * data set content was JSON or not, method is expected to provide a JSON output. It's up to the implementation to:
     * <ul>
     ...
     * 
     * @param dataSetMetadata The {@link org.talend.dataprep.dataset.objects.DataSetMetadata data set} to read content from.
     * @return A valid <b>JSON</b> stream.
     */
    InputStream get(DataSetMetadata dataSetMetadata);

    /**
     * Deletes the {@link org.talend.dataprep.dataset.objects.DataSetMetadata data set}. No recovery operation is expected.
