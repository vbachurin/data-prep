...
import org.talend.dataprep.dataset.configuration.DataScienceStatistics;
...
public class QualityAnalysis {
    ...
    public void analyzeQuality(Message message) {
        try {
            ...
            datasetLock.lock();
            synchronized (DataScienceStatistics.class) {
                try (StatisticsClientJson statisticsClient = applicationContext.getBean(StatisticsClientJson.class)) {
