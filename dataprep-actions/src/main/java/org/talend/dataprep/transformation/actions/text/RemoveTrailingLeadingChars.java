 ...
 */
@Action(AbstractActionMetadata.ACTION_BEAN_PREFIX + RemoveTrailingLeadingChars.ACTION_NAME)
public class RemoveTrailingLeadingChars extends AbstractActionMetadata implements ColumnAction {

    /**
     * The action name.
     */
    public static final String ACTION_NAME = "remove_trailing_leading_chars"; //$NON-NLS-1$
    ...
    public List<Parameter> getParameters() {
        ...
        parameters.add(SelectParameter.Builder.builder()
                ...
                .item("custom", CUSTOM_PADDING_CHAR_PARAMETER) //$NON-NLS-1$
    ...
    public void compile(ActionContext context) {
        ...
        if (context.getActionStatus() == ActionContext.ActionStatus.OK) {
            try {
                context.get(STRING_CONVERTRT, p -> new StringConverter());
    ...
    public void applyOnColumn(DataSetRow row, ActionContext context) {
        ...
        final String toRemove = row.get(columnId);
        if (toRemove != null) {
            final Map<String, String> parameters = context.getParameters();
            String removeChar;
            if ("custom".equals(parameters.get(PADDING_CHAR_PARAMETER))) { //$NON-NLS-1$
            ...
            row.set(columnId, stringConverter.removeTrailingAndLeading(toRemove, removeChar));
        }
    }
