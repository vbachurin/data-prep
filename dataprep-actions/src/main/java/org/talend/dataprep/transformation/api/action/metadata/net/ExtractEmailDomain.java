 ...
 */
@Component(ActionMetadataAdapter.ACTION_BEAN_PREFIX + ExtractEmailDomain.EXTRACT_DOMAIN_ACTION_NAME)
public class ExtractEmailDomain extends ActionMetadataAdapter implements ColumnAction {
