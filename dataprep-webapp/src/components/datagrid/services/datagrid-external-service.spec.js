describe('Datagrid external service', function () {
    ...
    beforeEach(inject(function (StatisticsService, SuggestionService, StateService) {
    ...
    describe('on active cell event', function () {
        it('should update playground right panel on active cell changed after a 200ms delay', inject(function ($timeout, DatagridExternalService, StatisticsService, SuggestionService, StateService) {
            //given
            DatagridExternalService.init(gridMock);
            var args = {cell: 1};
        ...
        it('should NOT update playground right panel on active cell changed if column and tab are the same', inject(function ($timeout, StateService, DatagridExternalService, StatisticsService, SuggestionService) {
            //given
            DatagridExternalService.init(gridMock);
            var args = {cell: 1};
            ...
            expect(StateService.updateSelectedColumnsStatistics.calls.count()).toBe(1);
        ...
        it('should NOT change suggestion tab on active cell changed if wanted tab is the same', inject(function ($timeout, StateService, DatagridExternalService, StatisticsService, SuggestionService) {
            //given
            DatagridExternalService.init(gridMock);
            ...
            expect(StateService.updateSelectedColumnsStatistics.calls.count()).toBe(2);
            expect(StatisticsService.updateStatistics.calls.count()).toBe(2);
            expect(SuggestionService.setColumn.calls.count()).toBe(2);
            expect(SuggestionService.selectTab.calls.count()).toBe(1);
        }));

        it('should cancel the pending right panel update and schedule a new one', inject(function ($timeout, DatagridExternalService, StatisticsService, SuggestionService, StateService) {
            //given
            DatagridExternalService.init(gridMock);
        ...
        it('should do nothing when no cell is active', inject(function ($timeout, DatagridExternalService, StatisticsService, SuggestionService, StateService) {
            //given
            DatagridExternalService.init(gridMock);
    ...
    describe('on header click event', function () {
        it('should update playground right panel on header click after a 200ms delay', inject(function ($timeout, DatagridExternalService, StatisticsService, SuggestionService, StateService) {
            //given
            DatagridExternalService.init(gridMock);
            var args = {
                column: {id: '0001'}
        ...
        it('should update playground right panel on header right click after a 200ms delay', inject(function ($timeout, DatagridExternalService, StatisticsService, SuggestionService, StateService) {
            //given
            DatagridExternalService.init(gridMock);
            var args = {
                column: {id: '0001'}
        ...
        it('should NOT update playground right panel on header click when column and tab are the same', inject(function ($timeout, StateService, DatagridExternalService, StatisticsService, SuggestionService) {
            //given
            DatagridExternalService.init(gridMock);
            var args = {
                column: {id: '0001'}
        ...
        it('should NOT update playground right panel on header right click when column and tab are the same', inject(function ($timeout, StateService, DatagridExternalService, StatisticsService, SuggestionService) {
            //given
            DatagridExternalService.init(gridMock);
            var args = {
                column: {id: '0001'}
        ...
        it('should NOT update suggestions and stats when column is the same', inject(function ($timeout, StateService, DatagridExternalService, StatisticsService, SuggestionService) {
