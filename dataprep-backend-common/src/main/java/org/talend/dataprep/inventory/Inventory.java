...
/**
 * This class groups all the contains of a folder. I contains all the datasets, the preparations and the sub-folders recursively contained
 * TODO: This class duplicates in some sense FolderContent. We must find a way to only use folder inventory.
 */
