...
public interface FilterService {
     ...
     * @param filterAsString A filter as string that follow conditions as defined in <a href="https://in.talend.com/9082609">MDM wiki</a>
     * @return A {@link Predicate} to be used to filter rows in actions.
