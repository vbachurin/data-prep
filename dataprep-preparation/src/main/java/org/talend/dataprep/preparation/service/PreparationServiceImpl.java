...
public class PreparationServiceImpl implements PreparationService {
     ...
     */
    public String update(String id, final PreparationMessage preparation) {
     ...
     */
    @Override
    public String updateStepMetadata(final String preparationId, final List<Step> steps) {
     ...
     * @return the preparation details.
     */
    public PreparationMessage getDetails(String id) {
    ...
    @Override
    public void addPreparationAction(final String preparationId, final List<AppendStep> steps) {
    ...
    public void appendSteps(String id, final List<AppendStep> stepsToAppend) {
        ...
        final Preparation preparation = get(id);
        // no preparation found
        if (preparation == null) {
            throw new TDPException(PREPARATION_DOES_NOT_EXIST, build().put("id", id));
        }
    ...
    public void updateAction(final String preparationId, final String stepToModifyId, final AppendStep newStep) {
        ...
        final Preparation preparation = get(preparationId);
